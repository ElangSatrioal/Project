     ...
     <div class = "search">
        <div class = "container">
            <form action = "wisata.php"> 
                <input type="text" name = "search" placeholder = "Telusuri" autocomplete = "off">
        ...
        <div class="section">
            <div class="container">
                <h3 class = "daftar-wisata">Daftar Wisata</h3>
                <div class="box">
                    <?php 
                    $wisata = mysqli_query($koneksi, "SELECT * FROM tempat_wisata LEFT JOIN adminbiro USING (id_admin) WHERE status_wisata = 1  ORDER BY id_wisata ASC ");
